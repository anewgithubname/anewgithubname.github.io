...
- (NeurIPS2026), Shannon, L.\*, **Liu, S.**, Reluga, K., Distribution Shift in Missing Data Imputation: A Risk-Based Perspective and Importance-Weighted Correction under MAR, _NeurIPS2026_, [arxiv](https://arxiv.org/abs/2602.06713)

- (NeurIPS2026), Zang, Y.\*, **Liu, S.**, Lin, J., Guidance For Prior Change via Density Ratio Estimation, _NeurIPS2026_, [arxiv](https://arxiv.org/abs/2608.21729).

- (NeurIPS2026), Khoo, S.\*, **Liu, S.**, Beaumont M., Local Manifold Identification with Latent Linear Models and OT Flows, _NeurIPS2026_. 

- (ICML2026), Wang, Y.\*\#, Wang, L.\#, **Liu, S.**, Suzuki, T. Zero-Flow Encoders, _ICML2026_, [arxiv](https://arxiv.org/abs/2602.00797). \# Equal Contribution. 
...
- (ICML2025), Givens, J. \*, **Liu, S.**, Reeve, H., Score Matching with Missing Data, _ICML2025_.
	- [**Outstanding paper of ICML2025**](https://icml.cc/virtual/2025/awards_detail)
...
- (AISTATS2025), Williams, D. J.\*\#, Wang, L.\*\#, Ying, Q.\*, **Liu, S.**, Kolar M., High-Dimensional Differential Parameter Inference in Exponential Family using Time Score Matching, _AISTATS2025_, [arxiv](https://arxiv.org/abs/2410.10637). \#Equal Contribution. 
...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/anewgithubname/lamfeeling.github.io/settings). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
